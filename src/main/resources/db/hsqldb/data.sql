...
INSERT INTO causes(id,name,description,budget_target,organisation,active,budget_achieved) VALUES (1,'Cause 1', 'Descripcion cause 1',27185.32, 'Organisation 1', true, 0.0);
INSERT INTO causes(id,name,description,budget_target,organisation,active,budget_achieved) VALUES (2, 'Cause 2','Descripcion cause 2', 78637.52, 'Organisation 2', true, 0.0);
INSERT INTO causes(id,name,description,budget_target,organisation,active,budget_achieved) VALUES (3, 'Cause 3','Descripcion cause 3', 36424.12, 'Organisation 3', true, 0.0);
INSERT INTO causes(id,name,description,budget_target,organisation,active,budget_achieved) VALUES (4, 'Cause 4', 'Descripcion cause 4',87932.21,'Organisation 4', true, 0.0);
INSERT INTO causes(id,name,description,budget_target,organisation,active,budget_achieved) VALUES (5, 'Cause 5','Descripcion cause 5', 87543.52, 'Organisation 5', true, 0.0);
